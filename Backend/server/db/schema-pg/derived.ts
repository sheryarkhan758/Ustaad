...
// Produced from ../schema/derived.ts by scripts/generate-pg-schema.ts.
...
import { index, integer, primaryKey, real, pgTable, text, uniqueIndex } from 'drizzle-orm/pg-core';
 ...
 */
export const tutorReliability = pgTable(
  'tutor_reliability',
  {
    tutorId: text('tutor_id')
      .primaryKey()
 ...
 */
export const tutorSearchSignals = pgTable(
