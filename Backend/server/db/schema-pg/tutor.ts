...
// Produced from ../schema/tutor.ts by scripts/generate-pg-schema.ts.
...
export const tutorSubjectClaims = pgTable(
 ...
 */
export const tutorRates = pgTable(
  'tutor_rates',
  {
    id: pk(),
    tutorId: text('tutor_id')
 ...
 */
export const tutorSafetyConstraints = pgTable(
